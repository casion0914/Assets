...
internal class LoadBalancingPeer : PhotonPeer
{
    ...
    public virtual bool OpJoinLobby(TypedLobby lobby = null)
    {
        ...
        //parameters[(byte)ParameterCode.PhoneID] = MainController.PhoneID;
#if UNITY_EDITOR
		parameters[(byte)ParameterCode.OpenID] = "o3LILj0qtkR6lO1qDpcWL1SegdBg";
		parameters[1] = "casion";
		parameters[2] = "1";
		parameters[3] = "http://thirdwx.qlogo.cn/mmopen/vi_32/uNY1KNfjLx6NEtnqAjxMgRXasHExkGcPVWvjImiaaXA305MErsmVvbLtkFQxjxpB2cQ9WGv6icG8Xwh6sgSLDynA/132";
#elif UNITY_IOS||UNITY_ANDROID||UNITY_STANDALONE_WIN||UNITY_STANDALONE_OSX
		if(!string.IsNullOrEmpty(MainController.OpenID))
		{
			parameters[(byte)ParameterCode.OpenID] = MainController.OpenID;
			parameters[1] = MainController.NickName;
			parameters[2] = MainController.sex;
			parameters[3] = MainController.HeadIMG;
		}
		else 
		{
		parameters[(byte)ParameterCode.PhoneID] = MainController.PhoneID;
...
public class ActorProperties
{
    ...
    public const byte Sex = 252;

    public const byte Picture = 251;
    public const byte UID = 250;
    public const byte ip = 230;
    public const byte log = 229;//精度

    public const byte lat = 228;//纬度


    public const byte Coins = 226;

    public const byte Dimond = 225;
}
...
public class EventCode
{
    ...
    //坐下、准备
    public const byte GetReady = 199;

    public const byte ShakeDice = 198;

    public const byte Bet = 197;

    public const byte ReShake = 196;

    public const byte MoveDiceOut = 195;

    //服务器发送骰字点数跟结果
    public const byte SendDiceCount = 194;

    //public const byte DiceResult = 198;
}
...
public class ParameterCode
{
    ...
    //用户属性
    public const byte OpenID = 190;

    public const byte PhoneID = 189;
}
...
public class OperationCode
{
    ...
    public const byte StartGame = 199;

    public const byte Ready = 198;
}
