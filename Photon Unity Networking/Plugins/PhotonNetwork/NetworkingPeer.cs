    ...
    public void OnOperationResponse(OperationResponse operationResponse)
    {
        ...
        switch (operationResponse.OperationCode)
        {
            ...
            case OperationCode.CreateGame:
                {
                    ...
                    //����������Response,������matsterSever
                    //�ڶ����ǽ���gameServer���͵�respons
                    if (this.Server == ServerConnection.GameServer)
                    {
                        this.GameEnteredOnGameServer(operationResponse);

                        MainController.CreateRoomResponse(operationResponse);
                    }
                    else
                    {
                        if (operationResponse.ReturnCode != 0)
            ...
            case OperationCode.JoinGame:
                {
                    ...
                    else
                    {
                        ...
                        MainController.JoinRoomResponse(operationResponse);
                    }
                    break;
                }
            ...
            case OperationCode.JoinLobby:
                ...
                if (dic.Count > 0)
                    MainController.SetUserInfo(dic);
        ...
        switch (photonEvent.Code)
        {
            ...
            case EventCode.GameListUpdate:
                {
                    ...
                    //if (MainController._GameView != null)
                    //    MainController._GameView.ShowRooms();
                    SendMonoMessage(PhotonNetworkingMessage.OnReceivedRoomListUpdate);
                    break;
                }
            ...
            case EventCode.Join:
                ...
                else
                {
                    ...
                    MainController.JoinRoomEvent(photonEvent);
                }
                #endregion
                break;
            ...
            case EventCode.Leave:
                ...
                MainController.LeaveRoomEvent(actorNr);
                break;

            //case EventCode.GetReady:
            //    Debug.Log(actorNr + "׼��");
            //    //MainController._GameController.GetReady(actorNr);
            //    break;


            //case EventCode.Bet:
            //    //MainController._GameController.Bet(photonEvent);
            //    break;
            ...
            //�������������ֵ��������
            //case EventCode.SendDiceCount:

                //MainController._GameController.DiceResult(photonEvent);
                //break;

            //case EventCode.MoveDiceOut:
            //    //DiceGame.MoveDiceOut(photonEvent);
            //    break;
            case PunEvent.RPC:
            ...
            default:
                if (photonEvent.Code < 200)
                {
                    ...
                    else
                    {
                        ...
                        MainController.SetEventData(photonEvent);
                    }
                }
                break;
        }
