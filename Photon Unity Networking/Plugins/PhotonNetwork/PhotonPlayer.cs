...
public class PhotonPlayer : IComparable<PhotonPlayer>, IComparable<int>, IEquatable<PhotonPlayer>, IEquatable<int>
{
    ...
    public Hashtable AllProperties
    {
        get
        {
            ...
            allProps[ActorProperties.UID] = this.UID;

            allProps[ActorProperties.Sex] = this.Sex;
            allProps[ActorProperties.Picture] = this.HeadIMG;
            allProps[ActorProperties.Coins] = this.Coins;
            allProps[ActorProperties.log] = this.log;
            allProps[ActorProperties.lat] = this.lat;
